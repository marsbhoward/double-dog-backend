...
Dare.create(text: "Until your next turn you can change the person who has to drink(can only be used once)", :points => 0, :shots=>0)
...
Dare.create(text: "Be blindfolded for the rest of the game", :points =>3, :shots=>1 )
...
Dare.create(text: "Everyone in the group must put a thumb up if the last time they had oral sex they were the last to recieve or a thumbs down if they were the last to give. Thumbs down take a shot, thumbs up loose a piece of clothing... if you haven’t done either do both", :points =>1, :shots=>2 )
Dare.create(text: "Staring with you, take turns naming a color continue until someone hesitated or repeats a color, that person drinks", :points =>0, :shots=>1 )
Dare.create(text: "Loose x article(s) of clothing (x is the number of penalty shots you have taken)", :points =>3, :shots=>2 )
Dare.create(text: "Pick someone and guess their underwear color if you are correct they drink, if you are wrong you drink.", :points =>1, :shots=>0 )
Dare.create(text: "The person with the least penalties drinks(if there is a tie all those people drink)", :points =>0, :shots=>1 )
Dare.create(text: "The person with the most penalties drinks(if there is a tie all those people drink)", :points =>0, :shots=>1 )
...
Dare.create(text: "Next time you have to drink, [RandomPlayer] has to drink with you", :points =>0, :shots=>1 )
Dare.create(text: "You are [RandomPlayer]’s drinking buddy. Until it is your turn again every time they drink, you drink", :points =>1, :shots=>2 )
Dare.create(text: "When someone has to drink, you can make them take a double", :points =>0, :shots=>1 )
Dare.create(text: "Everyone who is single drinks", :points =>0, :shots=>1 )
Dare.create(text: "Anyone who has went to the bathroom since this game started, drink", :points =>0, :shots=>1 )
Dare.create(text: "On the count of 3 have a staring contest with [RandomPlayer] first one blink drinks", :points =>1, :shots=>2 )
Dare.create(text: "Everyone with an inne bellybutton drinks", :points =>0, :shots=>1 )
Dare.create(text: "Everyone who is shorter than you drinks", :points =>0, :shots=>1 )
Dare.create(text: "Everyone who is taller than you drink", :points =>0, :shots=>1 )
Dare.create(text: "Flip a coin, if heads you drink if tails everyone else drinks", :points =>1, :shots=>0 )
...
Dare.create(text: "Think of a number 1-10, everyone that guesses your number correctly doesn’t have to drink, every else does", :points =>0, :shots=>1 )
...
Dare.create(text: "Challenge [RandomPlayer] to a thumb war loser drinks", :points => 1, :shots=>2)
...
Dare.create(text: "The person with the longest first name take a shot, if it is a tie both drink", :points => 1, :shots=>0)
...
Dare.create(text: "Wear your underwear on your head unitl it is your turn again", :points => 1, :shots=>1)
...
Dare.create(text: "Let the group Youtube a song for you to preform. If they don't like your performence take two shots", :points => 1, :shots=> 1)
Dare.create(text: "Give [RandomPlayer] your best pick up line. if the group thinks its bad take a shot", :points => 1, :shots=> 2)
Dare.create(text: "Market your genitals to the group like a used car salsemen, they decide if you take a shot or not based on your performence", :points => 1, :shots=> 2)
...
Dare.create(text: "Write a positive post of this game on your instagram (dont forget to tag @sixtyone19)", :points => 1, :shots=> 1)
