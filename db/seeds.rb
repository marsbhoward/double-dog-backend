...
Dare.create(text: "Lick the bottom of [RandomPlayer]'s foot ", :points => 2, :shots=>2)
...
Dare.create(text: "Drop ice down your pants", :points => 3, :shots=>1)
...
Dare.create(text: "You receive a four handed massage from two players of your choice. No parts of your exposed body can be left un-massaged", :points =>1, :shots=>1 )
...
Dare.create(text: "Strip to your underwear for one turn then put all of your clothes back on or take off one piece of clothing", :points =>2, :shots=>2 )
...
Dare.create(text: "Slowest to raise both hands, take a shot", :points => 1, :shots=>0)
