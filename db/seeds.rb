...
Dare.create(text: "Allow the person to your right to tickle you for 15 seconds", :points => 2, :shots => 3)
...
Dare.create(text: "Everyone vote on one person to take a shot(if a tie all those players take a shot) ", :points =>0, :shots=>0 )
...
Dare.create(text: "The person with the least penalties takes a shot(if a tie all those players take a shot)", :points =>0, :shots=>1 )
Dare.create(text: "The person with the most penalties takes a shot(if a tie all those players take a shot)", :points =>0, :shots=>1 )
Dare.create(text: "The next time you take a penalty you can choose someone else to take it for you(still counts as your penalty)", :points =>0, :shots=>1 )
...
Dare.create(text: "Everyone pick either heads or tails. Flip a coin and everyone who called it wrong take a shot ", :points =>1, :shots=>0 )
...
Dare.create(text: "Skip your next dare but accept it as if you completed it(if there is a timer involved in it take a shot)", :points => -1, :shots=>0)
...
Dare.create(text: "Write a positive post of this game on your instagram (don't forget to tag @sixtyone19)", :points => 1, :shots=> 2)
